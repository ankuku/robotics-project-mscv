...
**1. Navigation of a robot, Turtlebot 2 in this case**
We make use of packages compiled by the Robotics Lab, France team at Condorcet (https://github.com/roboticslab-fr), University of Burgundy.

The package used for initialization of the robot and navigation is **turtlebot_vibot**.
